									...
									if(map)
									{
										...
										if(first != 0)
											...
											{"type":"Feature","id":'+i+',"geometry":{"type":"Point","coordinates":['+map[0]+', '+map[1]+']},\
												"properties" : \
												{\
													"balloonContentHeader": "<div class=\'pp_block1\'><p class=\'tt\'>Адрес</p><p>'+point_name[i]+'</p></div>", \
													"balloonContentBody": "<div class=\'pp_block2\'><p class=\'tt\'>Телефон</p><p>8-918-325-70-02</p><p class=\'tt\'>Режим работы</p><p>Пн–пт, 9:00–19:00<br>Сб–Вс, 10:00–17:00</p>",\
													"balloonContentFooter": "<form class=\'pp_form\' method=\'POST\' action=\'/personal/order/make/\'><input type=\'hidden\' name=\'city_id\' value=\''+city_id+'\' /><input type=\'hidden\' name=\'change_dmethod\' value=\''+dil+'\' /><input type=\'hidden\' name=\'dil_address\' value=\''+$("input[name='city']").val() + ', ' + point_name[i] +'\' /><input type=\'hidden\' name=\'change_step\' value=\'3\' /><input type=\'submit\' value=\'Заберу здесь\'></form>" \
												}\
											}';
									}
							...
							else
							{
								...
								if(map)
								{
									...
									{"type":"Feature","id":1,"geometry":{"type":"Point","coordinates":['+map[0]+', '+map[1]+']},\
										"properties" : \
										{\
											"balloonContentHeader": "<div class=\'pp_block1\'><p class=\'tt\'>Адрес</p><p>'+point_name[0]+'</p></div>", \
											"balloonContentBody": "<div class=\'pp_block2\'><p class=\'tt\'>Телефон</p><p>8-918-325-70-02</p><p class=\'tt\'>Режим работы</p><p>Пн–пт, 9:00–19:00<br>Сб–Вс, 10:00–17:00</p>",\
											"balloonContentFooter": "<form method=\'POST\' action=\'/personal/order/make/\'><input type=\'hidden\' name=\'change_step\' value=\'3\' /><input type=\'submit\' value=\'Заберу здесь\'></form>" \
										}\
									}';
								}
							}
