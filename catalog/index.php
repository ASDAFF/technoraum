...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_PROPERTY_CODE" => array(
			...
			13 => "PROF_PYLESOS",
			14 => "KOMPLEKTACIYA_NASOSA",
			15 => "Komplektaciya_polomoechnoj_mashiny",
			16 => "Komplektaciya_podmetalnyh_mashiny",
			17 => "A_PYLESOSA",
			18 => "KOMPLEKTASIYA_STEKLOOCHISTITELYA",
			19 => "KOMPLEKTUYUSHCHIE_PODMETALNYH_MASHIN",
			20 => "PODOGREV_VODY",
			21 => "CHARACTERISTIC",
			22 => "APPLICATION",
			23 => "COMPLETE_PAR",
			24 => "KOMPLEKTACIYA_AVD",
			25 => "COMPLETE",
			26 => "POTREBLYAEMAYA_MOSHCHNOST",
			27 => "COMPLETE_PYLESOSA",
			28 => "WEIGTH",
			29 => "",
		),
