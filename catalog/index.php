...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_PROPERTY_CODE" => array(
			...
			7 => "POTREBLYAEMAYA_MOSHCHNOST",
			8 => "MAX_POTREBLYAEMAYA_MOSHCHNOST",
			9 => "TIP_UBORKI",
			10 => "AVTONOMNYJ",
			11 => "PROF_PYLESOS",
			12 => "A_PYLESOSA",
			13 => "KOMPLEKTASIYA_STEKLOOCHISTITELYA",
			14 => "KOMPLEKTUYUSHCHIE_PODMETALNYH_MASHIN",
			15 => "COMPLETE_PYLESOSA",
			16 => "MOSHCHOST_VSASYVANIYA",
			17 => "PODOGREV_VODY",
			18 => "SOVMESTIMAYA_TEKHNIKA",
			19 => "CHARACTERISTIC",
			20 => "APPLICATION",
			21 => "COMPLETE_PAR",
			22 => "KOMPLEKTACIYA_AVD",
			23 => "COMPLETE",
			24 => "WEIGTH",
			25 => "",
		),
