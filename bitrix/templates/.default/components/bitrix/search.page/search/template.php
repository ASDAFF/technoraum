...
<?if(isset($arResult["REQUEST"]["ORIGINAL_QUERY"])):
	...
	<?elseif(count($arResult["SEARCH"])>0):?>
		...
		<?foreach($arResult["SEARCH"] as $arItem):?>
			<? $arItem["URL"] = explode("?" , $arItem["URL"]); $arItem["URL"] = $arItem["URL"][0]; $arItem["URL"] .= "/"; ?>
			<div class="search-item">
			<?
				$arItem["URL"] = str_replace("//" , "/" , $arItem["URL"]); 
			?>
		...
		<?endforeach;?>
		<?if($arParams["DISPLAY_BOTTOM_PAGER"] != "N") echo "<div class='pagination'>".$arResult["NAV_STRING"]."</div>"; ?>
