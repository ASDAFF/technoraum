	...
	<form method="post" name="form1" action="<?=$APPLICATION->GetCurUri()?>" enctype="multipart/form-data" role="form">
		...
		<?
			if($_SESSION["DISCOUNT"])
			{
				...
				?>
				<div class="form-group">
					<label class="main-profile-form-label main-profile-password col-sm-12 col-md-3 text-md-right">Персональная скидка: </label>
					<div class="col-sm-12">
						<input class="form-control" readonly type="text" value="<?=$_SESSION["DISCOUNT"]?>%" />
					</div>
				</div>
				<?
			}
