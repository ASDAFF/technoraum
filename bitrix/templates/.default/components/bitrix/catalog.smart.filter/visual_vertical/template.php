...
<style>
	...
	.bx_ui_slider_handle{border: 1px solid rgb(53, 162, 232);border-radius: 20px;top: -7px !important;background: rgb(255, 255, 255) !important;}
	.bx_ui_slider_range{z-index:70 !important;}
</style>
<div class="bx_filter <?=$templateData["TEMPLATE_CLASS"]?> cat_filter_block">
	<div class="bx_filter_section" style="border:none;background:none;">
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			foreach($arResult["ITEMS"] as $key=>$arItem)
			{
				...
				if(isset($arItem["PRICE"])):
					...
					$min_price = ($arItem["VALUES"]["MIN"]["HTML_VALUE"]) ? $arItem["VALUES"]["MIN"]["HTML_VALUE"] : "";
					$min_price = number_format($min_price, 0, '.', '');

					$max_price = ($arItem["VALUES"]["MAX"]["HTML_VALUE"]) ? $arItem["VALUES"]["MAX"]["HTML_VALUE"] : "";
					$max_price = number_format($max_price, 0, '.', '');
					?>
					<div class="bx_filter_parameters_box active cat_filter_block_div">
						<span class="bx_filter_container_modef"></span>
						<div class="bx_filter_parameters_box_title title" onclick="smartFilter.hideFilterProps(this)"><?=$arItem["NAME"]?></div>
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container">
								...
								<div class="bx_ui_slider_track" id="drag_track_<?=$key?>">
									...
									?>
									<div class="bx_ui_slider_part p1"><span style="margin-left:-10px;"><?=$price1?></span></div>
									<div class="bx_ui_slider_part p2"><span style="margin-left:-10px;"><?=$price2?></span></div>
									<div class="bx_ui_slider_part p3"><span style="margin-left:-10px;"><?=$price3?></span></div>
									<div class="bx_ui_slider_part p4"><span style="margin-left:-10px;"><?=$price4?></span></div>
									<div class="bx_ui_slider_part p5"><span style="margin-left:-10px;"><?=$price5?></span></div>
									...
									<div class="bx_ui_slider_range noUi-horizontal" id="drag_tracker_<?=$key?>"  style="left: 0%; right: 0%;">
					...
					$arJsParams = array(
						...
						"fltMinPrice" => $arItem["VALUES"]["MIN"]["VALUE"] ,
						"fltMaxPrice" => $arItem["VALUES"]["MAX"]["VALUE"],
						"precision" => $precision,
			...
			foreach($arResult["ITEMS"] as $key=>$arItem)
			{
				...
				if (
					...
					continue;
				?>
				<div class="cat_filter_block_div <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif?>">
					<span class="bx_filter_container_modef"></span>
					<p class="title" onclick="smartFilter.hideFilterProps(this)"><?=$arItem["NAME"]?></p>
					<div class="cat_filter_block_div_inner">
						<div class="bx_filter_parameters_box_container">
						<?
						...
						switch ($arItem["DISPLAY_TYPE"])
						{
							case "A"://NUMBERS_WITH_SLIDER
								...
								<div class="bx_filter_parameters_box_container_block">
									<div class="bx_filter_input_container">
										<input
											...
											name="<?echo $arItem["VALUES"]["MIN"]["CONTROL_NAME"]?>"
											id="<?echo $arItem["VALUES"]["MIN"]["CONTROL_ID"]?>"
											value="<?echo number_format(($arItem["VALUES"]["MIN"]["HTML_VALUE"]) ? $arItem["VALUES"]["MIN"]["HTML_VALUE"] : "" , 1 , "." , " ")?>"
											placeholder="<?=number_format($arItem["VALUES"]["MIN"]["VALUE"], 1, '.', '')?>"
											size="5"
											onkeyup="smartFilter.keyup(this)"
										/>
									</div>
								...
								<div class="bx_filter_parameters_box_container_block">
									<div class="bx_filter_input_container">
										<input
											...
											name="<?echo $arItem["VALUES"]["MAX"]["CONTROL_NAME"]?>"
											id="<?echo $arItem["VALUES"]["MAX"]["CONTROL_ID"]?>"
											value="<?echo number_format(($arItem["VALUES"]["MAX"]["HTML_VALUE"]) ? $arItem["VALUES"]["MAX"]["HTML_VALUE"] : "" , 1 , "." , " ")?>"
											placeholder="<?=number_format($arItem["VALUES"]["MAX"]["VALUE"], 1, '.', '')?>"
											size="5"
											onkeyup="smartFilter.keyup(this)"
										/>
									</div>
								...
								<div class="bx_ui_slider_track" id="drag_track_<?=$key?>">
									<?
									$value1 = number_format($arItem["VALUES"]["MIN"]["VALUE"] , 1 , "." , " ");
									$value2 = number_format($arItem["VALUES"]["MIN"]["VALUE"] + round(($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"])/4) , 1 , "." , " ");
									$value3 = number_format($arItem["VALUES"]["MIN"]["VALUE"] + round(($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"])/2) , 1 , "." , " ");
									$value4 = number_format($arItem["VALUES"]["MIN"]["VALUE"] + round((($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"])*3)/4) , 1 , "." , " ");
									$value5 = number_format($arItem["VALUES"]["MAX"]["VALUE"] , 1 , "." , " ");
									?>
									<div class="bx_ui_slider_part p1"><span style="margin-left:-10px;"><?=$value1?></span></div>
									<div class="bx_ui_slider_part p2"><span style="margin-left:-10px;"><?=$value2?></span></div>
									<div class="bx_ui_slider_part p3"><span style="margin-left:-10px;"><?=$value3?></span></div>
									<div class="bx_ui_slider_part p4"><span style="margin-left:-10px;"><?=$value4?></span></div>
									<div class="bx_ui_slider_part p5"><span style="margin-left:-10px;"><?=$value5?></span></div>
							...
							default://CHECKBOXES
								...
								<?foreach($arItem["VALUES"] as $val => $ar):?>
									<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx_filter_param_label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
										<span class="bx_filter_input_checkbox" style="max-width:100%;">
											<input
												type="checkbox"
												...
												onclick="smartFilter.click(this)"
											/>
											<span style="margin-left:0;display:inline-block;" class="bx_filter_param_text" title="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?></span>
										</span>
									</label>
								<?endforeach;?>
						<?
