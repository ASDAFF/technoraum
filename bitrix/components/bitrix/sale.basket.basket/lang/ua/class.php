...
$MESS["SBB_PRODUCT_QUANTITY_CHANGED"] = "Вибачте, але вказана раныше кількість товару недоступна.<br>Встановлено найближче доступне значення.";
$MESS["SBB_BASKET_ITEM_WRONG_AVAILABLE_QUANTITY"] = "Вибачте, але вказана кількість товару в даний момент недоступна.<br>Встановлено попереднє коректне значення.";
?>