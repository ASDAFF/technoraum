...
elseif($incMod == '2')
	ShowNote(GetMessage("ALTASIB_GEOBASE_DEMO"));
...
$arComponentParameters["PARAMETERS"]["SMALL_ENABLE"] = array(
	"PARENT" => "BASE",
	"NAME" => GetMessage("ALTASIB_GEOBASE_SMALL_ENABLE"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => 'Y',
	"SORT" => 110,
);
if ($arCurrentValues['SMALL_ENABLE'] == 'Y')
{
	$arComponentParameters["PARAMETERS"]["SMALL_TEXT"] = array(
		"PARENT" => "BASE",
		"NAME" => GetMessage("ALTASIB_GEOBASE_TEXT_SMALL"),
		"TYPE" => "STRING",
		"DEFAULT" => "",
		"SORT" => 110,
	);
...
$arComponentParameters["PARAMETERS"]["LOADING_AJAX"] = array(
	"PARENT" => "BASE",
	"NAME" => GetMessage("ALTASIB_GEOBASE_SC_LOAD_AFTER"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "N",
	"SORT" => 120,
);
