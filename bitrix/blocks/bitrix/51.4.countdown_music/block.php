<section
		class="landing-block landing-block-node-img u-bg-overlay g-flex-centered g-bg-attachment-fixed g-bg-img-hero g-bg-black-opacity-0_4--after g-pt-100 g-pb-30"
	...
	<div class="landing-block-node-container container u-bg-overlay__inner">
		<div class="landing-block-node-title-container container g-max-width-800 text-center g-mb-35 g-mb-65--sm u-heading-v2-2--bottom g-brd-primary">
			<h2 class="landing-block-node-title text-uppercase g-line-height-1 g-font-weight-700 g-font-size-30 g-font-size-40--md g-color-white g-mb-0">
				Upcoming events</h2>
		</div>
