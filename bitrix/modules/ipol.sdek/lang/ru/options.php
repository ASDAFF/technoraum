...
$MESS ['IPOLSDEK_OPT_defMode'] = "Рассчитывать средние габариты для ";
	// Общие заявки
$MESS ['IPOLSDEK_OPT_deliveryAsPosition'] = "Указывать доставку отдельной товарной позицией <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-deliveryAsPosition\", this);'></a>";
$MESS ['IPOLSDEK_OPT_normalizePhone'] = "Адаптация номера телефона <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-normalizePhone\", this);'></a>";
$MESS ['IPOLSDEK_OPT_addData'] = "Указывать дату доставки <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-addData\", this);'></a>";
	// НДС
...
$MESS ['IPOLSDEK_OPT_addMeasureName'] = "Подписывать размерность дробного количества товаров <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-addMeasureName\", this);'></a>";
...
$MESS['IPOLSDEK_OPT_ensureProc']    = "Величина страховки от стоимости товаров (%)";
	// Настройки доставки
$MESS['IPOLSDEK_OPT_mindNDSEnsure'] = "Учитывать НДС страховки <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-mindNDSEnsure\", this);'></a>";
$MESS['IPOLSDEK_OPT_forceRoundDelivery'] = "Округлять стоимость доставки <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-forceRoundDelivery\", this);'></a>";
