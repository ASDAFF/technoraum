...
$MESS["NBRAINS_WIDTH_SLIDER"] = "";
$MESS["NBRAINS_WIDTH_SLIDER"] = "размер по горизонтали в пикселях";
$MESS["NBRAINS_HEIGHT_SLIDER"] = "размер по вертикали в пикселях";
$MESS["NBRAINS_HIDDEN_ARROWS_DESC"] = "Скрывает элемент управления, когда мышь покидает слайдер";
$MESS["NBRAINS_YES"] = "Да";
$MESS["NBRAINS_NO"] = "Нет";
$MESS["NBRAINS_PLACE_CONTROL_CHENGE_BTN"] = "расположение переключателей слайда";
$MESS["NBRAINS_TOP"] = "Сверху";
$MESS["NBRAINS_BOTTOM"] = "Снизу";
$MESS["NBRAINS_PROGRESS_BAR_HEIGHT"] = "ширина прогресс бара в пикселях";
$MESS["NBRAINS_PROGRESS_BAR_COLOR"] = "Цвет прогресс бара #";
$MESS["NBRAINS_PROGRESS_BAR_PLACE"] = "Расположение прогресс бара";
$MESS["NBRAINS_TIME_SLIDE"] = "время отображения слайда в секундах";
$MESS["NBRAINS_RIGHT_PX_TEXT"] = "расположение текста от правого края в px.";
$MESS["NBRAINS_TOP_PX_TEXT"] = "расположение текста от верхнего края в px.";
