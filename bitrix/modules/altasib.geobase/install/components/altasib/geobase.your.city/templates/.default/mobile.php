...
<div id="altasib_geobase_mb_window">
	<div id="altasib_geobase_mb_window_block">
		<a href="#" title="<?=GetMessage("ALTASIB_GEOBASE_CLOSE");?>">
			<div id="altasib_geobase_mb_close_kr"></div>
		</a>
		<div id="altasib_geobase_mb_page">
			<div class="altasib_geobase_yc_mb_ttl"><?=GetMessage("ALTASIB_GEOBASE_YOUR_".$sMode)?></div><?
			...
			if(($arResult["CODE"] == 00000000000 || empty($arResult["REGION"]["NAME"])) && empty($arResult["auto"]["CITY_NAME"])){?>
				...
				<div class="altasib_geobase_mb_your_city_block">
					<div class="altasib_geobase_mb_your_city"><?=GetMessage("ALTASIB_GEOBASE_NOT_".$sMode);?></div>
				</div>
			<a id="altasib_geobase_yc_none" class="altasib_geobase_yc_mb_btn" href="#"><?=GetMessage("ALTASIB_GEOBASE_SELECT_".$sMode);?></a><?
			}
			else {?>

			<div class="altasib_geobase_mb_your_city_block">
				<span class="altasib_geobase_mb_your_city"><?=$sCity;?></span><?
				if(!empty($sRegion)):?><span class="altasib_geobase_mb_your_city_2"><?=$sRegion;?></span><?endif;
				if(!empty($sCoutnry)):?><span class="altasib_geobase_mb_your_city_2"><?=$sCoutnry;?></span><?endif;
				?>

			</div>
			<a class="altasib_geobase_yc_mb_btn" onclick="altasib_geobase.yc_yes_click('<?echo(!empty($arResult["CODE"])? $arResult["CODE"] : $arResult["REGION"]["CODE"]);?>'<?echo(!empty($arResult["REGION"]["CODE"]) ? ",'".$arResult["REGION"]["CODE"]."'" : "");?>); return false;" href="#"><?=GetMessage("ALTASIB_GEOBASE_YES");?></a>
			<a id="altasib_geobase_yc_n" class="altasib_geobase_yc_mb_btn" href="#"><?=GetMessage("ALTASIB_GEOBASE_NO");?></a><?
			}?>
