...
<div class="alx-main" style="text-align:center">
	<div class="alx-gbase-main-box" id="alxLoaderUI">
		...
		<img class="ag_waiting" id="altasib_geobase_wait" src="/bitrix/images/altasib.geobase/wait.gif">
	...
	<div class="alx-gbase-main-box" id="alxLoaderUI_MM">
		...
		<img class="ag_waiting" id="altasib_geobase_wait_mm" src="/bitrix/images/altasib.geobase/wait.gif">
