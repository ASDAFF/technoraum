        ...
        else
        {
            ...
            else
            {
                ...
                if($allUrlsByCond)
                {
                    ...
                    {
                        $incompleteUrl = array();
                        $incompleteUrl['CONDITION_ID'] = $arFields['condition_id'];
                        $incompleteUrl['REAL_URL'] = $arFields['real_url'];
                        $incompleteUrl['NEW_URL'] = $arFields['new_url'];
                        $incompleteUrl['NAME'] = $arFields['name'];
                        $incompleteUrl['PROPERTIES'] = serialize($arFields['properties']);
                        $incompleteUrl['iblock_id'] = $arFields['iblock_id'];
                        $incompleteUrl['section_id'] = $arFields['section_id'];
                        $incompleteUrl['PRODUCT_COUNT'] = $arFields['product_count'];
                        $incompleteUrl['DATE_CHANGE'] = new \Bitrix\Main\Type\DateTime(date('Y-m-d H:i:s'), 'Y-m-d H:i:s');
                        $incompleteUrl['IN_SITEMAP'] = 'Y';

                        \Sotbit\Seometa\SeometaUrlTable::add($incompleteUrl);
                    }
                }
                else
                {
                    $newUrl = array();
                    $newUrl['CONDITION_ID'] = $arFields['condition_id'];
                    $newUrl['REAL_URL'] = $arFields['real_url'];
                    $newUrl['NEW_URL'] = $arFields['new_url'];
                    $newUrl['NAME'] = $arFields['name'];
                    $newUrl['PROPERTIES'] = serialize($arFields['properties']);
                    $newUrl['iblock_id'] = $arFields['iblock_id'];
                    $newUrl['section_id'] = $arFields['section_id'];
                    $newUrl['PRODUCT_COUNT'] = $arFields['product_count'];
                    $newUrl['DATE_CHANGE'] = new \Bitrix\Main\Type\DateTime(date('Y-m-d H:i:s'), 'Y-m-d H:i:s');
                    $newUrl['IN_SITEMAP'] = 'Y';
