...
$arAllOptions = Array(
	array(
		"category_level",
		GetMessage("DC_CATEGORY_LEVEL"),
		array(
			"selectbox",
			array(
				'first' => GetMessage("DC_CATEGORY_FIRST"),
				'last' => GetMessage("DC_CATEGORY_LAST"),
			),
		),
	),
	array(
		"widget_url",
		GetMessage("DC_WIDGET_URL"),
		array(
			"text",
            35
		),            
